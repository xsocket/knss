	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListCategory media">
			...
			<div class="media-left">
				<img alt="<?php echo K2HelperUtilities::cleanHtml($this->category->name); ?>" 
			...
			<div class="media-body">
				...
				<!-- Category title -->
				<h4 class="media-heading"><?php echo $this->category->name; ?>
				...
				<div class="media-desc"><?php echo $this->category->description; ?></div>
				<?php endif; ?>
			</div>
		</div>
		<?php endif; ?>
