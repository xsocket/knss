...
abstract class KunenaForum
{
	...
	protected static function buildVersion()
	{
		...
		self::$version_date = ('2017-03-31' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2017-03-31';
		self::$version_name = ('Gayal' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Gayal';
	}
}
