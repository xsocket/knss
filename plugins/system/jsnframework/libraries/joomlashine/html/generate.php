...
<div class="clr"></div>';
	...
	public static function aboutInfo($info, $products = array())
	{
		...
		$html[] = '
			<h2 class="jsn-section-header"><a href="' . JRoute::_($links['info']) . '" target="_blank" rel="noopener noreferrer">JSN ' . preg_replace('/JSN\s*/i', '', JText::_($name)) . ' ' . $edition . '</a>';
		...
		$html[] = '</h2>';
			...
			<div class="jsn-product-intro jsn-section-content">
				<div class="jsn-product-thumbnail">';
					...
					{
						$html[] = '<a href="' . JRoute::_($links['info']) . '" target="_blank" rel="noopener noreferrer"><img src="' . JURI::root(true) . '/administrator/components/' . JFactory::getApplication()->input->getCmd('option') . '/assets/images/product-thumbnail.png" alt="" /></a>';
					}
				$html[] = '</div>
			...
			if ($showSeeOtherProduct)
			{
				...
				if ( ! empty($links['review']))
				{
					$html[] = '
							<li>
								<a href="' . JRoute::_($links['review']) . '" target="_blank" rel="noopener noreferrer" class="btn"><i class="icon-comment"></i>&nbsp;' . JText::_('JSN_EXTFW_ABOUT_REVIEW') . '</a>
							</li>';
				}
				...
				$html[] = '
					...
					<div class="pull-right">
						<ul class="jsn-list-horizontal">
							<li>
								<a class="jsn-icon24 jsn-icon-social jsn-icon-facebook" href="http://www.facebook.com/joomlashine" title="' . JText::_('JSN_EXTFW_ABOUT_FB') . '" target="_blank" rel="noopener noreferrer"></a>
							</li>
							<li>
								<a class="jsn-icon24 jsn-icon-social jsn-icon-twitter" href="http://www.twitter.com/joomlashine" title="' . JText::_('JSN_EXTFW_ABOUT_TW') . '" target="_blank" rel="noopener noreferrer"></a>
							</li>
							<li>
								<a class="jsn-icon24 jsn-icon-social jsn-icon-youtube" href="http://www.youtube.com/joomlashine" title="' . JText::_('JSN_EXTFW_ABOUT_YT') . '" target="_blank" rel="noopener noreferrer"></a>
							</li>
						</ul>
					</div>
					<div class="clearbreak"></div>
...
<ul class="jsn-footer-menu">
	<li class="first">';
		...
		{
			$html[] = '
		<a href="' . JRoute::_($links['doc']) . '" target="_blank" rel="noopener noreferrer">' . JText::_('JSN_EXTFW_GENERAL_DOCUMENTATION') . '</a>
	</li>
	<li>';
		}

		$html[] = '
		<a href="http://www.joomlashine.com/contact-us/get-support.html" target="_blank" rel="noopener noreferrer">' . JText::_('JSN_EXTFW_GENERAL_SUPPORT') . '</a>
	</li>';
		...
		if ( ! empty($links['review']))
		{
			$html[] = '
	<li>
		<a href="' . JRoute::_($links['review']) . '" target="_blank" rel="noopener noreferrer">' . JText::_('JSN_EXTFW_GENERAL_VOTE') . '</a>
	</li>';
		}
	...
	<li class="jsn-iconbar">
		...
		<a title="' . JText::_('JSN_EXTFW_GENERAL_FACEBOOK') . '" target="_blank" rel="noopener noreferrer" href="http://www.facebook.com/joomlashine"><i class="jsn-icon16 jsn-icon-social jsn-icon-facebook"></i></a><a title="' . JText::_('JSN_EXTFW_GENERAL_TWITTER') . '" target="_blank" rel="noopener noreferrer" href="http://www.twitter.com/joomlashine"><i class="jsn-icon16 jsn-icon-social jsn-icon-twitter""></i></a><a title="' . JText::_('JSN_EXTFW_GENERAL_YOUTUBE') . '" target="_blank" rel="noopener noreferrer" href="http://www.youtube.com/joomlashine"><i class="jsn-icon16 jsn-icon-social jsn-icon-youtube""></i></a>
	</li>
</ul>
<ul class="jsn-footer-menu">
	<li class="first">';
		...
		{
			$html[] = '
		<a href="' . JRoute::_($links['info']) . '" target="_blank" rel="noopener noreferrer">JSN ' . preg_replace('/JSN\s*/i', '', JText::_($name)) . ' ' . $edition . ' v' . $version . '</a>';
		}
		else
		{
		...
		$html[] = ' by <a href="http://www.joomlashine.com" target="_blank" rel="noopener noreferrer">JoomlaShine.com</a>';
...
<ul class="jsn-footer-menu">
	<li class="jsn-iconbar first">
		<span class="hasTip" title="' . JText::_('JSN_EXTFW_GENERAL_POWERADMIN') . '"><a target="_blank" rel="noopener noreferrer" href="http://www.joomlashine.com/joomla-extensions/jsn-poweradmin.html">
			<i class="jsn-icon32 jsn-icon-products jsn-icon-poweradmin"></i>
		</a></span>
		<span class="hasTip" title="' . JText::_('JSN_EXTFW_GENERAL_IMAGESHOW') . '"><a target="_blank" rel="noopener noreferrer" href="http://www.joomlashine.com/joomla-extensions/jsn-imageshow.html">
			<i class="jsn-icon32 jsn-icon-products jsn-icon-imageshow"></i>
		</a></span>
		<span class="hasTip" title="' . JText::_('JSN_EXTFW_GENERAL_UNIFORM') . '"><a target="_blank" rel="noopener noreferrer" href="http://www.joomlashine.com/joomla-extensions/jsn-uniform.html">
			<i class="jsn-icon32 jsn-icon-products jsn-icon-uniform"></i>
		</a></span>
		<span class="hasTip" title="' . JText::_('JSN_EXTFW_GENERAL_MOBILIZE') . '"><a target="_blank" rel="noopener noreferrer" href="http://www.joomlashine.com/joomla-extensions/jsn-mobilize.html">
			<i class="jsn-icon32 jsn-icon-products jsn-icon-mobilize"></i>
		</a></span>
		<span class="hasTip" title="' . JText::_('JSN_EXTFW_GENERAL_PAGEBUILDER') . '"><a target="_blank" rel="noopener noreferrer" href="http://www.joomlashine.com/joomla-extensions/jsn-pagebuilder.html">
			<i class="jsn-icon32 jsn-icon-products jsn-icon-pagebuilder"></i>
		</a></span>
		<span class="hasTip" title="' . JText::_('JSN_EXTFW_GENERAL_EASYSLIDER') . '"><a target="_blank" rel="noopener noreferrer" href="http://www.joomlashine.com/joomla-extensions/jsn-easyslider.html">
